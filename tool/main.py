...
try:
    ...
    from tool.parser import parse_conflicts, validate_file_has_conflicts
    from tool.resolver import resolve_conflict_interactive, apply_resolutions, save_file
...
def main():
    parser = argparse.ArgumentParser(description="Merge-Consistency-Engine CLI")
