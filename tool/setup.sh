...
BIN_PATH="/usr/local/bin/mce"

echo "Setting up Merge-Consistency-Engine (mce) for Mac/Linux..."

# 1. Create the shell script at /usr/local/bin/mce
...
echo "  2. Run 'mce --all' to resolve everything."
echo "  3. Run 'mce filename' to resolve a specific file."
echo ""
